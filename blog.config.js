...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1c91ac3005428174b51bf65583a41ed0,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HeartBird', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Learning AI', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.heartbird.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blog, AI, heartbird', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi! welcome to Heartbird\'s space, Love AI; Love life; Love you.',
